---
title: JavaScript深入之从原型到原型链【转载】
date: 2017-10-31 14:46:26
categories: 前端
tags: [js,转载]
---
> 本文转载自冴羽博客[javascript深入系列](https://github.com/mqyqingfeng/Blog/issues/17)，清楚解释了js原型继承的机制，以图片清晰描述出构造函数、实例、原型、prototype、\_\_proto\_\_、constructor之间的关系。另外也推荐冴羽大大的另一个系列[javascript专题系列](https://github.com/mqyqingfeng/Blog/issues/53)，相信会给研读的小伙伴柳暗花明之感。
...
![构造函数和实例原型的关系图](http://qiniu.huzerui.com/image/2017-10-31-prototype1.png)
...
![实例与实例原型的关系图](http://qiniu.huzerui.com/image/2017-10-31-prototype2.png)
...
![实例原型与构造函数的关系图](http://qiniu.huzerui.com/image/2017-10-31-prototype3.png)
...
![原型的原型关系图](http://qiniu.huzerui.com/image/2017-10-31-prototype4.png)
...
![原型链示意图](http://qiniu.huzerui.com/image/2017-10-31-prototype5.png)
